...
-- No supe interpretar cuando se altera el orden, asi que supuse que si vos apilas y 
--desapilas una lista el resultado tiene que quedar igual que antes de apilar
